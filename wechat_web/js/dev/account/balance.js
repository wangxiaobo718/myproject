$(document).ready(function() {
    ...
    //储值
    $("body").on("click",'#par-value-box .par-value',function(){
        $(this).addClass('on').attr('data-status',true).siblings().removeClass('on').attr('data-status',false);
        $err.hide();
    });
    $btnConfirmParVal.on('click',function(){
