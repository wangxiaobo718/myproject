...
/*$(function(){
	$("#topCode").load('code/top.txt',function(){
		$("head").append($("#topCode").html());
		$("#topCode").remove();
		$("#bottomCode").load('code/bottom.txt',function(){
			var str = $("#bottomCode").html();
			$("body").append(str);
			$("#bottomCode").remove();
			var str1 = $("#bottomWay").html().toString();
	...
	if($("body").hasClass("yes")){
		$("#regCode").load('code/reg.txt',function(){
			$("head").append($("#regCode").html());
			$("#regCode").remove();
		});
		var inputBox = "<input type='hidden' value='' name='source' id='source'/>";
